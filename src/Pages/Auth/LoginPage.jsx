...
function LoginPage() {
  return (
    <section className="flex flex-col md:flex-row h-screen w-screen">
      <div className=" md:w-1/2 h-full flex flex-col justify-center items-center bg-white relative">
        <div className="w-[448px]">
          <div className=" flex flex-col items-start md:top-10 md:left-10">
            ...
            <Link
              to="/"
              className="text-[12px] font-medium text-gray-500 hover:text-indigo-600 transition-colors duration-300 my-[32px] py-[16px] px-[32px]"
            >
              &larr; Back to Home
            </Link>
          </div>
